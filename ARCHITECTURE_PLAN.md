...
- Storing explicitly also gives you relationship **history** for free (`discovered_in_scan_id`) and lets a relationship survive even if one side is later marked deleted (useful for "what used to be attached to this now-deleted instance").
